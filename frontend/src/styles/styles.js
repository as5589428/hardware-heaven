const styles = {
    ...
    productTitle: 'text-[30px] font-[600] font-Roboto text-[#333]',
    ...
    shop_name:"pt-3 text-[17px] text-blue-400 pb-3",
    active_indicator:"absolute bottom-[-27%] left-0 h-[3px] w-full bg-[crimson]",
    button: 'w-[180px] bg-black h-[50px] my-8 flex items-center justify-center rounded-xl cursor-pointer',
